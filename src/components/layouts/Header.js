...
&nbsp;&nbsp;&nbsp;
                <li id="nav-item noti-container message" onClick={() => this.setState({ sideVisible: !sideVisible })} style={{ cursor: 'pointer' }}>
